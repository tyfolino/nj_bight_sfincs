...
### ⏳ 2026-09-14 14:35 — two solves DONE (`bed-nobuildings` 24 h 50, `wave-noig` 21 h 47, both hal, full 73-step maps, 12 zsmax blocks, `engine.txt` = the patched bin, `segments 0`); `wave-noig` validate 61542346 RUNNING (hal0259); premier + `wave-fw02` at sim-h 66, `wave-apex` at 54; ✅ **Deltares ISSUE FILED by the user 09-14 ~14:20** (number: ⏳ fill in) — PR next, from the staged worktree branch `nj/snapwave-winddir-main`
